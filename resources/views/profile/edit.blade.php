    ...
    <div x-data="{ 
        ...
        <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-[2.5rem] shadow-sm border border-slate-100 dark:border-slate-700 p-10 overflow-hidden relative">
                <div class="absolute -right-10 -top-10 w-40 h-40 bg-indigo-50 dark:bg-indigo-900/20 rounded-full opacity-50"></div>
                
                <div class="relative z-10">
                    <div class="flex items-center gap-4 mb-10">
                        <div class="w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-indigo-100 dark:shadow-none">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-wrap gap-3">
                                ...
                                <a href="{{ route('lang.switch', $code) }}" 
                                   class="px-6 py-3 rounded-2xl border-2 transition-all font-bold text-sm {{ app()->getLocale() == $code ? 'border-indigo-600 bg-indigo-50 text-indigo-600 dark:bg-indigo-900/30' : 'border-slate-100 text-slate-400 dark:border-slate-700 dark:text-slate-500 hover:border-indigo-200' }}">
                                    {{ $label }}
                                </a>
                                @endforeach
                            </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <button @click="toggleDarkMode()" 
                                    class="w-full flex items-center justify-between px-6 py-4 bg-slate-50 dark:bg-slate-900/50 rounded-[2rem] group border border-transparent hover:border-indigo-200 transition-all">
                                <div class="flex items-center gap-4">
                                    <div class="w-10 h-10 rounded-full flex items-center justify-center transition-all" 
                                         :class="darkMode ? 'bg-indigo-900 text-indigo-400' : 'bg-amber-100 text-amber-600'">
                                ...
                                <div class="w-12 h-6 rounded-full p-1 transition-colors duration-300" 
                                     :class="darkMode ? 'bg-indigo-600' : 'bg-slate-200'">
