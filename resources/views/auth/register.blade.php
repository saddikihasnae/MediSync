<x-guest-layout>
    <div class="mb-8 text-center">
        <h2 class="text-2xl font-bold text-slate-800">{{ __('messages.register') }}</h2>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <!-- Name -->
        <div>
            <label for="name" class="block text-sm font-semibold text-slate-700 mb-1">{{ __('messages.name') }}</label>
            <div class="relative">
