    ...
    <div x-data="{ 
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center gap-6">
                ...
                <div>
                    <p class="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">{{ __('messages.total_patients') }}</p>
                    <h3 class="text-3xl font-black text-slate-800 tracking-tighter">{{ $stats['total'] }}</h3>
                </div>
            </div>
            <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center gap-6">
                            ...
                            <tr class="group hover:bg-slate-50/50 transition-colors">
                                ...
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-4 cursor-pointer" @click="openDetails(p)">
                                        ...
                                        <div>
                                            <p class="text-sm font-black text-slate-800" x-text="p.name"></p>
                                            <p class="text-[10px] font-bold text-slate-400 uppercase" x-text="p.email"></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-8 py-6">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-bold text-slate-600" x-text="p.phone || 'N/A'"></span>
                                    </div>
                                </td>
                                <td class="px-8 py-6">
                                    <span :class="{
                                ...
                                <td class="px-8 py-6 text-end">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <button @click="openDelete(p)" class="p-2.5 bg-slate-50 text-slate-400 hover:bg-rose-600 hover:text-white rounded-xl transition-all">
            ...
            <div @click.away="showDetailsModal = false" class="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl p-10 text-center">
                <template x-if="selectedPatient">
                    <div>
                        ...
                        <p class="text-sm font-bold text-slate-400 uppercase tracking-widest mb-8" x-text="selectedPatient.phone"></p>
        ...
        <!-- ========================================== -->
        <div x-show="showAddModal || showEditModal" x-cloak x-transition class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
            <div @click.away="showAddModal = false; showEditModal = false" class="bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl p-10 transform transition-all">
                <h2 class="text-2xl font-black text-slate-800 mb-8" x-text="showEditModal ? 'Edit Patient' : 'Add New Patient'"></h2>
        ...
        <!-- ========================================== -->
        <div x-show="showDeleteModal" x-cloak x-transition class="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md">
            <div class="bg-white w-full max-sm rounded-[2.5rem] shadow-2xl p-10 text-center">
